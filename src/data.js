...
export const about = {
  ...
  subtitle2:
    ' apicultores por admirarmos este animal magnífico, de mais de 100 milhões de anos, socialmente organizado e fundamental agente de polinização, ao buscar pólen e nectar no vai e vem incansável de suas visitas às flores.',
  subtitle21:
    ' responsáveis, proporcionamos às abelhas as melhores condições de conforto e proteção, para que façam o que melhor sabem, aproveitando a exuberante natureza da Serra Gaúcha brasileira, criadas livres e protegidas.',
  subtitle3:
